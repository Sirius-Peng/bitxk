...
│  科幻文学 公选 100  │ 金融学概论  共1个班   │ 关键词[___] 类型[全部] [x]查全部  │
│  体育/羽毛球 体育 50│ ┌──────────────────┐ │ [查询][停止]                     │
│  [添加][编辑][删除] │ │教学班 教师 容量    │ │ 筛选 [ ]有余量 [x]已满 [ ]冲突   │
│                     │ │      已选 余量    │ │      [ ]已选  [清除筛选]         │
│                     │ │003501 马明 120   │ │ ┌──────────────────────────────┐ │
│                     │ │       121   0 已满│ │ │课程 类型 教学班 教师 时间地点 │ │
│                     │ └──────────────────┘ │ │      容量 余量 状态          │ │
│                     │        [刷新]        │ └──────────────────────────────┘ │
├────────────────────┴──────────────────────┴──────────────────────────────────┤
...
| 栏 | 作用 |
|---|---|
| **左：要盯的课程** | 抢课任务的清单。选中的那门课会驱动中间栏 |
| **中：该任务的备选教学班** | 这门课有几个班、每个班的 **容量 / 已选人数 / 余量**、教师与时间地点。决定"值不值得等"看这里 |
